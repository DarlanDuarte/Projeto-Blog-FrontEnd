    ...
    <div className={``}>
      ...
      <div>
        ...
        <p className="text-justify px-2 font-medium">
          ...
          amanhecer traz consigo uma oportunidade renovada de avançar em direção
          aos nossos objetivos. Mesmo quando o caminho parece longo e árduo, a
          persistência e a determinação são nossos maiores aliados. Mantenha
          seus sonhos vivos, acredite na sua capacidade de superar obstáculos e
          lembre-se de que o sucesso é a jornada, não apenas o destino. Então,
          levante-se, siga em frente e faça cada passo contar em direção aos
          seus sonhos
        </p>
      </div>
      <div className={``}>
